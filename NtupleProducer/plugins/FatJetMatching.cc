...
void FatJetMatching::top_label(const l1t::PFJet* jet, const reco::GenParticle *parton, const reco::GenParticleCollection& genParticles, double distR)
{
  // top
...
void FatJetMatching::higgs_WW_label(const l1t::PFJet* jet, std::vector<const reco::GenParticle*>& hVV_daughters, double distR)
{
  enum WDecay {W_cs, W_qq, W_ev, W_mv, W_tauev, W_taumv, W_tauhv, W_null};
...
void FatJetMatching::higgs_ZZ_label(const l1t::PFJet* jet, std::vector<const reco::GenParticle*>& hVV_daughters, double distR)
{
...
void FatJetMatching::higgs_WHorZH_label(const l1t::PFJet* jet, std::vector<const reco::GenParticle*>& hVV_daughters, double distR)
{
...
void FatJetMatching::qcd_label(const l1t::PFJet* jet, const reco::GenParticleCollection& genParticles, double distR)
{
