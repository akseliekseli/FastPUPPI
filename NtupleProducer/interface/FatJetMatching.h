...
public:
  ...
  void flavorLabel(const l1t::PFJet *jet, const reco::GenParticleCollection& genParticles, double distR);

private:
  void top_label(const l1t::PFJet *jet, const reco::GenParticle *parton, const reco::GenParticleCollection& genParticles, double distR);
  void w_label(const l1t::PFJet *jet, const reco::GenParticle *parton, double distR, bool is_from_top);
  void z_label(const l1t::PFJet *jet, const reco::GenParticle *parton, double distR);
  void higgs_label(const l1t::PFJet *jet, const reco::GenParticle *parton, double distR);
  void higgs_WW_label(const l1t::PFJet* jet, std::vector<const reco::GenParticle*>& hVV_daughters, double distR);
  void higgs_ZZ_label(const l1t::PFJet* jet, std::vector<const reco::GenParticle*>& hVV_daughters, double distR);
  void higgs_WHorZH_label(const l1t::PFJet* jet, std::vector<const reco::GenParticle*>& hVV_daughters, double distR);
  void qcd_label(const l1t::PFJet *jet, const reco::GenParticleCollection& genParticles, double distR);
